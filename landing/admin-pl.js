...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const homeMap = [
    ...
    ['home-metric-tagline-pl','plMetricTagline','metricTagline','Odblokuj rynek wart 27 mld $, rosnący o 39,9% rocznie — dołącz do 10% odnoszących sukces.'],
    ['home-start-title-field-pl','plHomeStartTitle','homeStartTitle','Gotowy na start swojego modowego imperium?'],
    ['home-start-subtitle-field-pl','plHomeStartSubtitle','homeStartSubtitle','Dołącz do setek odnoszących sukces influencerów, którzy przekształcili swój wpływ w kwitnące marki modowe. Twoja podróż zaczyna się tutaj.'],
    ['home-feature1-title-field-pl','plHomeFeature1Title','homeFeature1Title','Szybki start'],
    ['home-feature1-desc-field-pl','plHomeFeature1Desc','homeFeature1Desc','Twoja marka na żywo w zaledwie 8 tygodni'],
    ['home-feature2-title-field-pl','plHomeFeature2Title','homeFeature2Title','Wykonane za Ciebie'],
    ['home-feature2-desc-field-pl','plHomeFeature2Desc','homeFeature2Desc','Zajmujemy się wszystkim, Ty skupiasz się na treściach'],
    ['home-feature3-title-field-pl','plHomeFeature3Title','homeFeature3Title','Sprawdzone wyniki'],
    ['home-feature3-desc-field-pl','plHomeFeature3Desc','homeFeature3Desc','Dołącz do 10% odnoszących sukces'],
    ['home-cta-field-pl','plHomeCtaText','homeCtaText','Zobacz, jak to działa']
  ];
